...
then
   ...
   echo "add method heur_cins" > ${SCIP_PATH}/scip/src/scip/patch.txt
   ln -s -f ${CODE_PATH}/heur_cins.c ${SCIP_PATH}/scip/src/scip/heur_cins.c
   ln -s -f ${CODE_PATH}/heur_cins.h ${SCIP_PATH}/scip/src/scip/heur_cins.h
   ...
   then
      ...
      rm -f ${SCIP_PATH}/scip/src/scip/heur_cins.c
      rm -f ${SCIP_PATH}/scip/src/scip/heur_cins.h

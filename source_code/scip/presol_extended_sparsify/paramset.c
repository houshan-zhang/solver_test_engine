   ...
   )
{
   ...
   /* explicitly disable extended sparsify presolver, if included */
#ifndef NDEBUG
   if( SCIPsetFindPresol(set, "extended_sparsify") != NULL )
#endif
   {
      SCIP_CALL( paramSetInt(paramset, set, messagehdlr, "presolving/extended_sparsify/maxrounds", 0, quiet) );
   }

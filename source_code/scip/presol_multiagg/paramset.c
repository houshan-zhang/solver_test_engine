   ...
   )
{
   ...
   /* explicitly disable multi-aggregation presolver, if included */
#ifndef NDEBUG
   if( SCIPsetFindPresol(set, "multiagg") != NULL )
#endif
   {
      SCIP_CALL( paramSetInt(paramset, set, messagehdlr, "presolving/multiagg/maxrounds", 0, quiet) );
   }
